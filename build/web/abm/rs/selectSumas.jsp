...
System.out.println ("selectSumas --> " + codRama +  "  " + codSubRama + "  " + iCodProd );
...
<form method="post" id="form1" name="form1">
   <input type="hidden" name="opcion" id="opcion">
    ...
    <input type="hidden" name="usuario" id="usuario" value="<%= sUsuario %>"> 
...
<table border='0' width='100%' cellpadding='2' cellspacing='0' align="left" style='margin-top:5;margin-bottom:5;'>
    <tr>
        ...
        <th align="center" width='160' colspan='2'>Sumas Aseguradas</th>  
    </tr>
    <tr>
        <th >&nbsp;</th>  
        <th >&nbsp;</th>  
        <th align="Center">M&iacute;nima</th>  
        <th align="Center">M&aacute;xima</th>  
    </tr>
<%          if (rs != null) {  
                    while (rs.next ()) {
                            iCantCob += 1;
...
<%                              iAnt = rs.getInt ("COD_SUB_RAMA");
    ...
    %>
                            ...
                            <INPUT type="hidden" id="SUMA_MIN_ANT_<%= iCantCob %>" name="SUMA_MIN_ANT_<%= iCantCob %>" value="<%= Dbl.DbltoStr(rs.getDouble ("MIN_SUMA_ASEGURADA"),2)%>">
                            ...
                            <TR>
                                ...
                                <td class='text'><INPUT type="text" id="SUMA_MIN_<%= iCantCob %>" name="SUMA_MIN_<%= iCantCob %>" onkeypress="return Mascara('D',event);" 
                                    class="inputTextNumeric" type="text"  size='13' maxlength='10' value='<%= Dbl.DbltoStr(rs.getDouble ("MIN_SUMA_ASEGURADA"),2)%>'>
                                </td>
