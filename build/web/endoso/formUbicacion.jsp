...
<% 
    ...
    if (oUbic != null ) {
        domicilio = oUbic.getdomicilio();
        localidad = oUbic.getlocalidad();
        codLocalidad = oUbic.getcodLocalidad();
        provincia    = oUbic.getprovincia();
        descProvincia = oUbic.getdescProvincia();
        codPostal    = oUbic.getcodPostal();
    }
...
function validateEmail( emailID ){
 ...
 function Validar () {
    ...
    if ( Trim($('#domicilio').val ()) === ""  ) {
        ...
        var ubic_dom = Trim($('#domicilio').val ().toUpperCase());
        for(var i=0; i< pClaves.length; i++ ){
            if (ubic_dom.indexOf( pClaves[i]) !== -1) {
                $('#mensaje_error').text("ERROR: EL DOMICILIO CONTIENE UNA DESCRIPCION NO VALIDA ") ;
                $('#domicilio').focus();
                return false;
            }
        }        
    ...
    <div class="container">
        ...
        <div class="menu">
         ...
         <div class="tabs-container"> 
            ...
            <input type="hidden" name="opcion"      id="opcion"      value="setFormUbicacion"/>
            ...
            <input type="hidden" name="cod_provincia" id="cod_provincia"   value="<%= provincia %>"/>
            <input type="hidden" name="cod_localidad" id="cod_localidad"   value="<%= codLocalidad %>"/>
            ...
            <div class="form-file">
                ...
                <h1 class="title-section hcotizadores">Domicilio del Tomador</h1>
                <div class="wrap-elements w15">
                ...
                <h1 class="title-section hcotizadores">Ubicaci&oacute;n de Riesgo</h1>
                <div class="wrap-elements w15">
                     <span class="item">Domicilio:</span>
                     <span class="item">Cod.Postal:</span>
                </div>
                <div class="wrap-elements w35">
                    <span class="item-result"><%= domicilio %></span>
                    <span class="item-result"><%= codPostal %></span>
                </div>
                <div class="wrap-elements w15">
                     <span class="item">Localidad:</span>
                     <span class="item">Provincia:</span>
                ...
                <div class="wrap-elements w35">
                    <span class="item-result"><%= localidad %></span>
                    <span class="item-result"><%= descProvincia %></span>
                </div>
                <div class="wrap-elements w50">
                    <label>Ingrese la nueva ubicaci&oacute;n:</label>
                    <input id="domicilio" name="domicilio" type="text" value="<%= domicilio %>"   
                            placeholder="domicilio" tabindex="4" title="domicilio"  size="50" maxlength="50" />
                </div>
                <div class="wrap-elements w50">
