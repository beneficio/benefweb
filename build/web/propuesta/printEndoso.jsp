...
<% Usuario usu = (Usuario) session.getAttribute("user");
   ...
   String numPropuesta = request.getParameter("num_propuesta");
   String sVolver = ( request.getParameter("volver") == null ? "" :  request.getParameter("volver")); 

   String sUrl=  Param.getAplicacion() + "servlet/EndosoServlet?opcion=printEndoso&formato=" + request.getParameter("formato") +  
   "&cod_rama=" + request.getParameter("cod_rama") + "&num_propuesta=" + numPropuesta; 
