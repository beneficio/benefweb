...
<%
   ...
   //System.out.println ("Opcionales:" + codRama + " " + codSubRama + " " + codOpcion + " " + codProd + " " + origen );
%>
<head>
...
<FORM name="formOpcion" id="formOpcion"  method="POST">
    ...
    <SELECT name="cod_opcion" id="cod_opcion" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size:11px;font-weight:normal;text-decoration: none; width:400px; height:22px;"
