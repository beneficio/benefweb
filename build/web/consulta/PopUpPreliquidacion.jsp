   ...
   <SCRIPT type="text/javascript" language="JavaScript" src="<%= Param.getAplicacion()%>script/formatos.js"></script>
     <script language='javascript'>
        ...
        function Aceptar () {
            ...
            if (confirm ("Esta usted seguro que desea recibir una copia de la póliza/endoso via mail ? ")) {
                if (window.opener) {
...
<form name='form1'>    
<input type="hidden" name="opcion" id="opcion" value="getPreLiq" >
<table border='0'  width='100%' height='100%' cellpadding='2' cellspacing='2' class='fondoForm'>
    <tr>
        <td width='100%' height='30' valign="top" class='titulo' align="center" >SOLICITUD DE PRE LIQUIDACION</td>
    </tr>
