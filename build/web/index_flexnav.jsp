...
<link href="/benef/script/flexnav/css/flexnav.css" media="screen, projection" rel="stylesheet" type="text/css"/>
...
<script src="/benef/script/flexnav/js/jquery.flexnav.min.js" type="text/javascript"></script>
   ...
   if (lPanel != null) {
     ...
     <div class="wrap-panel">
         ...
         <div class="panel">
             ...
             <span class="info-txt ok">Propuestas en carga pendiente de emisiÃ³n</span>
             <span class="result">3</span>
             <span class="info-txt alert">Propuestas RECHAZADAS</span>
             <span class="result">3</span>
             <span class="info-txt new">Polizas nuevas emitidas durante los Ãºltimos 30 dÃ­as</span>
             <span class="result">3</span>
         </div>
...
<%          if (lNovedades != null) {
    ...
    %>
               ...
               <div class="file <%= ( oMan.gettipoDoc()== null ? "" :  oMan.gettipoDoc().toLowerCase()) %>-mini">
                   <!-- Aca de identefica el icono del archivo con un class, es decir file + espacio y la extensiÃ³n | opciones: zip-mini, pdf-mini, xls-mini, doc-mini -->
