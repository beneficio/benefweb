...
//                                     parseInt (dateString.substring(0,2)) );
        ...
        if  ( codRama == "22" && ! ( codSubRama == "2"  || codSubRama == "9"  || codSubRama == "3")) {
            alert ("SubRama inválida, consulte con su representante comercial la forma de ingresar dicha propuesta ");               
            return document.getElementById('prop_subrama').focus();
        }      

        if ( (codRama != "22" || (codRama == "22" && codSubRama == "3")) && ( codPlan == "0" || codPlan == "-1") ) {
            alert ("Debe seleccionar un Plan válido, consulte con su representante comercial sobre Planes Especiales ");               
            return document.getElementById('prop_subrama').focus();
        }
 ...
 //       }
    ...
    function Refrescar ( codRama ) {
        if (navegador == 'Mozilla') {
            window.location.href = '<%= Param.getAplicacion()%>propuesta/formPropuestaVC.jsp?codRama=' + codRama;
        } else {
            window.location.href('<%= Param.getAplicacion()%>propuesta/formPropuestaVC.jsp?codRama=' + codRama );
        }
    }
...
<%                                      }
    %>
                                ...
                                <TR>
                                    ...
                                    <TD align="left"  class="text">
                                        <SELECT name="prop_subrama" id="prop_subrama" class="select" onchange="javascript:DoChangePlanes();"
                                            ...
                                            <%
                                                        lTabla = oTabla.getSubRamas(codRama);
                                                        for (int ii = 0; ii < lTabla.size(); ii++) {
                                                            Generico oObj = (Generico) lTabla.get(ii);
                                                                if ((codRama == 22 && (oObj.getCodigo() == 2 || oObj.getCodigo() == 9 || oObj.getCodigo() == 3) ) || codRama != 22) {
                                            %>
                                ...
                                <TR>
                                    ...
                                    <td class="text"  width='284' valign="middle" height='35'>
                                        <iframe  name="oFrameOpcionales" id="oFrameOpcionales" width="284" height="22"  marginheight="0" marginwidth="0" marginheight="0" align="top"  frameborder="0"  scrolling="no"
                                ...
                                <TR>
                                    <td align="left"  class="text" colspan='3' height="100%">
                                        <iframe  name="oFramePlanes" id="oFramePlanes" width="700" marginheight="0" marginwidth="0" marginheight="0" align="top"  frameborder="0"  scrolling="no"
                                                 src="<%= Param.getAplicacion()%>propuesta/rs/formPlanesVC.jsp?prop_vig=<%= codVig%>&cod_rama=<%=codRama%>&cod_sub_rama=<%= codSubRama%>&cod_plan=<%= (oProp == null || oProp.getcodPlan() == 0) ? -1 : oProp.getcodPlan()%>&cod_prod=<%= (oProp == null || oProp.getCodProd() == 0 ? (usu.getiCodProd() == 0 ? -1 : usu.getiCodProd()) : oProp.getCodProd())%>">
                                        </iframe>
                                    </td>
                                </TR>
                                <TR>
                                ...
                                <tr>
                                    <td align="left"  class="text" colspan='3' width="100%"  height="100%">
                                        <IFRAME name="oFrameFact" id="oFrameFact" width="100%"  marginwidth="0"
                    ...
                    <TR>
                        <TD>
                            <TABLE border='0' align='left' class="fondoForm" width='100%' style='margin-top:10;margin-bottom:10;'>
                                ...
                                <TR>
                                    <td width='15'>&nbsp;</td>
                                    <TD align="left" class='subtitulo' colspan="2">(El ingreso de Cl&aacute;usulas es solo para planes de Accidentes Personales)</TD>
                                </TR>
                                <TR>
                                    <td width='15'>&nbsp;</td>
                                    <TD align="left" class='text' valign="top" width='150' nowrap>Cl&aacute;usulas: </TD>
                                    <TD align="left" class='text' >
                                        <input type="CHECKBOX" value='<%= (oProp != null ? oProp.getclaNoRepeticion() : "")%>' name='prop_cla_no_repeticion'  id='prop_cla_no_repeticion' <%= ((oProp != null && oProp.getclaNoRepeticion().equals("S")) ? "checked" : " ")%>>&nbsp;Cl&aacute;usula de No Repetici&oacute;n<br>
                                        <input type="CHECKBOX" value='<%= (oProp != null ? oProp.getclaSubrogacion() : "")%>' name='prop_cla_subrogacion'    id='prop_cla_subrogacion'   <%= ((oProp != null && oProp.getclaSubrogacion().equals("S")) ? "checked" : " ")%>>&nbsp;Cl&aacute;usula de Subrogaci&oacute;n
                                    </TD>
                                </TR>
                                <TR>
                                    <td width='15'>&nbsp;</td>
...
<div id="divInfo" 
     ...
     style="visibility:hidden; position:absolute;top:0px; left:-400px;z-index:10000; padding:10px">
        ...
        <script>
          if (document.getElementById('oFramePlanes')) {
            var iframeElement = document.getElementById('oFramePlanes');
            if (navegador == 'Mozilla') {
                iframeElement.style.height="290";
            } else {
                iframeElement.style.height="230";
            }
          }

          if (document.getElementById('oFrameFact')) {
            var iframeElement2 = document.getElementById('oFrameFact');
            if (navegador == 'Mozilla') {
                iframeElement2.style.height="115";
            } else {
                iFrameElement2.style.height="140";
            }
          }
