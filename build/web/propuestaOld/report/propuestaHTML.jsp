...
<%                              if (oProp.getTipoPropuesta().equals("R")) {
    %>
                                    <TD align="left" class='text' width='500'><b><%=oProp.getBoca() %>&nbsp;-&nbsp;<%=nroPropDesc%>&nbsp;&nbsp;-&nbsp;Renueva p&oacute;liza&nbsp;<%= oProp.getNumPoliza() %></b></TD>
<%                              } else {
    %>
                    ...
                    <TR>
                        <TD>
                            <TABLE border='0' align='left' class="fondoForm" width='100%'style='margin-top:10;margin-bottom:10;'>                                       
                                ...
                                <TR>
                                    <td width='10'>&nbsp;</td>                                
                                    <TD align="left" class='text'>Forma de Pago:&nbsp;<B><%= oProp.getdescFormaPago() %>&nbsp;en&nbsp;<%= cantCuotas %>&nbsp;cuota/s</B>
                                </TD>
                            </TR>                                                       
			    <!-- Comienzo divs -->  
<%                      if ( formaPago == 1 ) {
                                ...
                                <TD valign="top">
                                    <TABLE  align="left" style="MARGIN-LEFT: 5px">
                                        ...
                                        <TR>
                                            ...
                                            <TD  width='200px'  class='text'><%=codBcoTarj %></TD>
                                        </TR>
                                        <TR>
                ...
                <TR>   
                     <TD>
                          <TABLE border='0' align='left' class="fondoForm" style='margin-top:10;margin-bottom:10;' width='100%'>                                       
                            ...
                            <TR>
                                <td width='10'>&nbsp;</td>
                                <TD align="left" class='text' valign="top" width='100' nowrap>Env&iacute;o de p&oacute;liza:</TD>
                                <TD align="left" class='text' >
                                    <input type="radio" value='S' name='prop_mca_envio_poliza' <%= (oProp.getMcaEnvioPoliza().equals ("S") ? "checked" : " ") %> readonly>&nbsp;Deseo recibir la p&oacute;liza.<br>
                                    <input type="radio" value='N' name='prop_mca_envio_poliza' <%= (oProp.getMcaEnvioPoliza().equals ("N") ? "checked" : " ") %> readonly>&nbsp;NO deseo recibir la p&oacute;liza.<br>
                                    <input type="radio" value='M' name='prop_mca_envio_poliza' <%= (oProp.getMcaEnvioPoliza().equals ("M") ? "checked" : " ") %> readonly>&nbsp;Deseo recibir la p&oacute;liza v&iacute;a mail.<br>
                                 </TD>                                
                            </TR>
