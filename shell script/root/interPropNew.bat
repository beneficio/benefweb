...
if [ -e bloq_new.flag ]; then
    echo "INTERFACE BLOQUEADA"
else
   echo date > bloq_new.flag
   echo "INTERFACE ACTIVA"
#---------------------------------------------------------------
# EJECUTAR PROGRAMA JAVA QUE ENVIA PROPUESTAS
#---------------------------------------------------------------
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.IntPropuestasPhpDC OL
echo "finalizo IntPropuestas"
rm /home/adrian/enviar/bloq_new.flag
fi
