...
#---------------------------------------------------------------
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes D 0
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes S 0
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes M 0
