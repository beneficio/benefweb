...
#---------------------------------------------------------------
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes S 16 
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes S 17
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes S 18
/usr/lib/jdk/bin/java -classpath $VARIABLE com.business.beans.ProcesarReportes S 19
