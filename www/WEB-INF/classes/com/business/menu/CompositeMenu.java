...
public class CompositeMenu extends Menu
{
    ...
    */
    public String render()
    {
     ...
     //   System.out.println(getUrl() + " "  + getMenuName());
        ...
        sb.append("\"black\",\"FAEBD7\",\"white\",\"#335588\",\"white\",\"#335588\",\"font-family:Tahoma, Verdana, Arial; font-size:12px;font-weight:normal,text-decoration:none;padding: 4px\");");
        sb.append("\n");
  ...
  /*  public boolean add(com.surassur.menu.Menu menu) throws NoSuchElementException {
    }    
