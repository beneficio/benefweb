 ...
 */
public class IntAvisoDeEmision {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            cons.setString (2, "COD_TEXTO_AVISO_EMISION");
            cons.execute();
            ...
            cons = dbCon.prepareCall(db.getSettingCall("INT_AVISOS_EMISION_PROCESAR ()"));
...
System.out.println ("LOTE A PROCESAR: " + lote);
                ...
                dbCon.setAutoCommit(false);
                cons = dbCon.prepareCall(db.getSettingCall("INT_AVISOS_EMISION_ENVIO (?,?,?,?,?,?,?)"));
        ...
        //                }
                        ...
                        if (rs.getString ("EMAIL") == null || rs.getString ("BODY") == null ||
                            ...
                            try {
                                dbCon.setAutoCommit(true);
                                cons2 = dbCon.prepareCall(db.getSettingCall("INT_AVISOS_EMISION_GRABAR (?,?,?,?)"));
