   ...
   /*datos cotizacion*/
    ...
    public void setDB (Connection dbCon) throws SurException {
      ...
      try {
            ...
            cons = dbCon.prepareCall(db.getSettingCall( "COT_ADD_COTIZACION(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)"));
            ...
            cons.setInt   (6, this.getcodActividad     () );
            cons.setInt   (7, this.getcodProvincia     () );
            cons.setInt   (8, this.getcodVigencia      () );
            cons.setInt   (9, this.getcantPersonas     () );
            cons.setDouble(10, this.getgastosAdquisicion() );
            cons.setDouble(11, this.getcapitalMuerte    () );
            cons.setDouble(12, this.getcapitalInvalidez () );
            cons.setDouble(13, this.getcapitalAsistencia() );
            cons.setDouble(14, this.getfranquicia       () );
            cons.setString(15, this.getuserId           () );
            cons.setInt   (16, this.getcodProd          () );
            cons.setString(17, this.gettomadorApe     () );
//            cons.setString(18, this.gettomadorNom     () );
            cons.setInt   (18, this.getcodOpcion()     );
            cons.setString(19, this.gettomadorTel     () );
            cons.setInt   (20, this.gettomadorCodIva  () );
            cons.setDouble(21, this.getprimaTar       () );
            cons.setDouble(22, this.getderEmi         () );
            cons.setDouble(23, this.getgda            () );
            cons.setDouble(24, this.getsubTotal       () );
            cons.setDouble(25, this.getiva            () );
            cons.setDouble(26, this.getssn            () );
            cons.setDouble(27, this.getsoc            () );
            cons.setDouble(28, this.getsellado        () );
            cons.setDouble(29, this.getpremio         () );      
            cons.setString(30, this.getabm            () );
            cons.setInt   (31, this.getcantCuotas     ());
            cons.setInt   (32, this.getcodActividadSec());
		...
		throw new SurException("Error al obtener la cotizacion: " + se.getMessage());
        } catch (Exception e) {
    ...
    public CotizadorAp setDBCambiarEstadoCotizacion ( Connection dbCon) throws SurException {
       try {
            dbCon.setAutoCommit(true);
...
//            System.out.println ("estado devuelto -> " + cons.getInt (1));
    ...
    public CotizadorAp getDB ( Connection dbCon) throws SurException {
       ResultSet rs = null;
        try {
