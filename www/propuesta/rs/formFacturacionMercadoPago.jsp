...
// System.out.println ("formCondicionFactuacion:" + codRama + " " + codSubRama + " " +  codProducto + " "+ codProd + " " + formaPago + "  " +
...
//                return true;
    ...
    function HabilitarDiv(divName) {
        ...
        if (divName != 0 ) {
            document.getElementById('div_MPAGO').style.visibility = 'hidden';
        }

         for (i = 0; i < aFPagosCod.length ;i++) {
             if ( divName  ==  aFPagosCod [i] ) {
                 if ( aFPagosTrat [i] == 'TARJETA' ||
                      aFPagosTrat [i] == 'CBU'  ||
                      aFPagosTrat [i] == 'SOBRE' ||
                      aFPagosTrat [i] == 'MPAGO') {
    ...
    <tr>
        <td width='100%' valign="top" height='100%' colspan="2">
            <table align="left" border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td height='40px' width='100%' valign="top" align="left" nowrap>
                        <div name="div_TARJETA" id="div_TARJETA" style="VISIBILITY: hidden; POSITION: absolute;">
                            <table  align="left" style="MARGIN-LEFT: 5px">
                                <tr>
                                    ...
                                    <td class="text_leyend" align="left" colspan="2" valign="middle"><span style="color:red;">Importante:&nbsp;</span>
...
<%
    ...
    %>
                        ...
                        <div id="div_MPAGO" name="div_MPAGO" style="VISIBILITY: visible; POSITION: absolute;">
                            <table border="0" align="left" style="MARGIN-LEFT: 5px">
                                <tr>
                                    <td  class="text" align="left" ><strong>Si selecciona Tarjeta a trav&eacute;z  de MERCADOPAGO podr&aacute;
                                            financiar el total del premio de la 1era. facturación hasta en 12 cuotas sin interes</strong><br/><br/>
