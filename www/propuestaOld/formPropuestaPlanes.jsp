...
<%                                      }
    %>
                                ...
                                <TR>
                                    ...
                                    <td class="text"  width='284px' valign="middle" height='35px' align="left">
                                        <iframe  name="oFrameOpcionales" id="oFrameOpcionales" style="width:350px; height:22px;"  marginheight="0" marginwidth="0" marginheight="0" align="top"  frameborder="0"  scrolling="no"
                                ...
                                <TR>
                                    <td align="left"  class="text" colspan='3' height="100%">
                                        <iframe  name="oFramePlanes" id="oFramePlanes" style="width: 900px; height: 250px;" marginheight="0" marginwidth="0" marginheight="0" align="top"  frameborder="0"  scrolling="no"
