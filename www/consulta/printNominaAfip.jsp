...
<% Usuario usu = (Usuario) session.getAttribute("user");
   ...
   sUrl=  Param.getAplicacion() +     
              "servlet/ConsultaServlet?opcion=getAseguradosAfip&formato=" +   request.getParameter("formato") +
              "&cod_rama=" +  request.getParameter("cod_rama")   +
              "&num_poliza=" +  request.getParameter("num_poliza") +              
              "&endoso=" + request.getParameter("endosoAfip")  ;
  try { 
