...
<html>
<head>
    <title>Copia de póliza/endoso</title>
...
<form name='form1'>
<input type="hidden" value="getCtaCte" name="opcion" id="opcion">
<table border='0'  width='100%' height='100%' cellpadding='2' cellspacing='2' class='fondoForm'>
    <tr>
        <td width='100%' height='30' valign="top" class='titulo' align="center" >SOLICITUD DE CUENTA CORRIENTE</td>
    </tr>
...
<%               LinkedList lProd = (LinkedList) session.getAttribute("Productores");
                 for (int i= 0; i < lProd.size (); i++) {
                    ...
                    out.print("<option value='" + String.valueOf (oProd.getsCodProdDC()) + "' " + (oProd.getiCodProd() == usu.getiCodProd () ? "selected" : " ") + ">" + oProd.getsDesPersona() + " (" + oProd.getiCodProd() + ")</option>");
                 }
%>
             </select>
        </td>
