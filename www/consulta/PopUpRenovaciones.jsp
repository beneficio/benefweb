...
<form name='form1'>
<input type="hidden" name="opcion" id="opcion" value="getRenoPend" >
<table border='0'  width='100%' height='100%' cellpadding='2' cellspacing='2' class='fondoForm'>
    <tr>
        <td width='100%' height='30' valign="top" class='titulo' align="center" >SOLICITUD DE RENOVACIONES PENDIENTES</td>
    </tr>
...
<%      }
    %>
    <tr>
        <td align="left"  class="text">Fecha de cierre&nbsp;<input type="text" name="fecha_hasta" id="fecha_hasta" size="12"
            maxlength="10"  onblur="validaFecha(this);" onkeypress="return Mascara('F',event);" value="">&nbsp;(dd/mm/yyyy)</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
    ...
    <tr>
        <td align="center"  valign="top"><input type="text" name="email" id="email" size='45' maxlength='60' value=<%= (usu.getEmail () == null ? "" : usu.getEmail ()) %>><br><br></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr valign="bottom" >
