...
<!--[if lt IE 7]>
            <p class="chromeframe">Estas usando un explorador obsoleto. <a href="https://browsehappy.com/">Actualiza ahora</a> o <a href="https://www.google.com/chromeframe/?redirect=true">instala Google Chrome Frame</a> para una mejor experiencia en el sitio.</p>
<![endif]-->
...
-->
    ...
    <span class="help">Seleccione la p&oacute;liza con el botón&nbsp;<a href="#" name="MP-Checkout" class="red-M-Rn-Ar" mp-mode="modal" >Pagar</a> </span>
    </div>
    ...
    <!--! left -->
    <!-- right -->
    <jsp:include page="/portal/right_clientes.jsp">
        <jsp:param name="page" value="home" />
    </jsp:include>
