...
<%
  ...
  if (urlExtranet == null) { urlExtranet =  "https://www.beneficioweb.com.ar/"; }
    ...
    <div class="five columns omega">
   	<!-- sidebar -->
    <aside id="sidebar">
        <div class="widget accesos">
            <h3>Accesos</h3>
            <div class="content_body">
            <a href="<%= urlExtranet %>portal/RedirecExtranet.html" target="_blank">Beneficio Web (productores)</a>
            <a href="<%= urlExtranet %>portal/RedirecClientes.html" target="_blank" title="Acceso a clientes">Beneficio On-line (clientes)</a>
            <a href="<%= Param.getAplicacion()%>PortalServlet?opcion=descargas" title="Formularios en formato pdf">Descarga de Formularios</a>
            <a href="<%= Param.getAplicacion()%>portal/cvForm.jsp" title="Trabajá con Beneficio SA">¿Querés ser Productor?</a>
            <a href="<%= Param.getAplicacion()%>portal/cvForm.jsp" title="Ingreso de curriculum vitae">Ingresá tu CV</a>
            </div>
        </div>
...
--%>
        ...
        <div class="widget telefonos">
          ...
          <div class="widget banner">
        	 <div class="content_body">
                     <a href="<%= Param.getAplicacion()%>portal/servicioAT.jsp" class="ser">Servicio de atenci&oacute;n al asegurado &rarr;</a>
             </div>
        </div>
