...
<link rel=stylesheet type="text/css" href="<%=Param.getAplicacion()%>css/estilos.css"/>
    ...
    <SCRIPT language="javascript">
     ...
     function Aceptar(){
         window.confirm("Confirma la solicitud de la presente cotización ?")
     ...
     function GenerarPropuesta(){
         if ( window.confirm("Esta seguro que usted desea solicitar la propuesta de la cotización ?") ) {
...
<%--     if ( usu.getiCodTipoUsuario() != 0  || ( usu.getusuario().equals ("VEFICOVICH") || usu.getusuario().equals ("PINO") || usu.getusuario().equals ("ADRIANA") ||
    ...
    --%>
            ...
            onmouseover="writetxt('Haga click aqui si usted desea solicitar la propuesta de dicha cotización')" onmouseout="writetxt(0)">
<%--      }
    --%>
        </td>
    </tr>
